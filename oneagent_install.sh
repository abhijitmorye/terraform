...
DYNATRACE_LOCAL_FILE=Dynatrace-OneAgent-Linux-1.303.62.20241129-131342.sh
DYNATRACE_HOST_GROUP=$3
...
# Install Agent
/bin/sh Dynatrace-OneAgent-Linux-1.303.62.20241129-131342.sh  --set-app-log-content-access=true --set-host-group=${DYNATRACE_HOST_GROUP}
if [ $? -ne 0 ]; then
